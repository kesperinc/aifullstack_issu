...
### 🤖 AI Model Allocation (Recommended)
- **Strategy/Ops (@ceo, @coo, @pm, @cmo)**: **GPT-4o** 권장 (비즈니스 로직 및 맥락 이해 우수).
- **Tech/Code (@sa, @se, @devops, @qa)**: **Claude 3.5 Sonnet** 권장 (최상위 코딩 실무 성능).
- **Research/Search (@researcher, @analyst)**: **Google (Gemini/Search)** 권장 (실시간 정보 검색 및 비용 최적화).
